...
function CompleteProfile() {
  ...
  const getData = async () => {
    try {
      const res = await fetch(
        `https://identitytoolkit.googleapis.com/v1/accounts:lookup?key=AIzaSyCwpa9W1-_fktr3vZIDdvjZZz4iy-3Knro`,
        {
          method: "POST",
  ...
  return (
    ...
    >
      ...
      <button
        className="bg-green-500 text-white px-4 py-2 mx-2 rounded hover:bg-green-600 transition-colors"
        onClick={getData}
      >
        Get Data
      </button>
